...
import com.mark1.exception.CEmailSigninFailedException;
import com.mark1.model.CommonResult;
import com.mark1.model.SingleResult;
import com.mark1.config.security.JwtTokenProvider;
...
public class SignController {
    ...
    public CommonResult signup(@ApiParam(value = "회원ID : 이메일", required = true) @RequestParam String id,
        ...
        userJpaRepo.save(User.builder().email(id).password(passwordEncoder.encode(password)).name(name)
